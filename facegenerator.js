...
function draw() {
  ...
  // scale whole face with mouseY (top=big, bottom=small)
  let faceScale = map(mouseY, 0, height, 1.2, 0.6);

  // eye openness changes a bit with mouseX
...
// SINGLE BANG ARC (on forehead)
  ...
  // tiny hint
  noStroke(); fill(255, 180); textSize(10);
  text("move mouse: scale/look  •  click: new variation", 8, height-8);
}
